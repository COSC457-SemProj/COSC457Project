 ...
 * @author David
 */
public class DepartmentUpdateForm extends javax.swing.JFrame {

    /**
     * Creates new form DepartmentForm
     */
    public DepartmentUpdateForm(String[][] results) {
        initComponents();
        id = results[0][0];
        deptLocNumBox.setText(results[0][1]);
        deptNameBox.setText(results[0][2]);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String[] values = new String[] {id, deptLocNumBox.getText(), deptNameBox.getText()};
        
        if(SystemInterface.update(department.getTableName(),
